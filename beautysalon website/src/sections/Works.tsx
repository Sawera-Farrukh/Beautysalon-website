...
export function Works() {
  ...
  const displayProjects = worksConfig.projects.slice(0, 4);
    ...
    >
      ...
      <div className="max-w-7xl mx-auto mb-16">
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between">
          ...
          <Link
            ref={viewAllRef}
            to="/gallery"
            className="hidden lg:inline-flex items-center gap-3 mt-8 lg:mt-0 px-8 py-4 bg-black text-white font-medium hover:bg-highlight transition-colors duration-300 group"
          >
            View All Gallery
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-12 text-center lg:hidden">
          <Link
            to="/gallery"
            className="inline-flex items-center gap-3 px-8 py-4 bg-black text-white font-medium hover:bg-highlight transition-colors duration-300 group"
          >
            View All Gallery
            <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform duration-300" />
          </Link>
